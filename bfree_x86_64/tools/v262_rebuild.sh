...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v262*.py tools/v262_rebuild.sh
python3 tools/fix_v262_resolve_loop_break_guest.py
...
sed -i 's/mmap96-v[0-9a-z]*/mmap96-v262/' userland/desktop_qt/guest_main.cpp
