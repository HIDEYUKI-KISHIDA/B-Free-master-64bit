...
cd "$ROOT"
python3 tools/fix_v208_changemember_guest.py
python3 tools/fix_v208_funcclasses_guest.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v208/' userland/desktop_qt/guest_main.cpp
