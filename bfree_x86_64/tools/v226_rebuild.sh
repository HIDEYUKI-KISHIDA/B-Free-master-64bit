...
for s in fix_v211_funcname_guest.py fix_v213_funcproto_guest.py fix_v214_revert_init_guest.py \
  ...
  fix_v224_iterator_guest.py fix_v225_proto_init_skip_guest.py fix_v226_ctor_finish_guest.py; do
  python3 "tools/$s"
done
...
sed -i 's/mmap96-v[0-9]*/mmap96-v226/' userland/desktop_qt/guest_main.cpp
