...
python3 tools/fix_v219_objectproto_guest.py
python3 tools/fix_v220_variant_sequence_guest.py
python3 tools/fix_v221_ctors_guest.py
python3 tools/fix_v222_ctor_heartbeats_guest.py
python3 tools/fix_v223_skip_regexp_error_ctors_guest.py
python3 tools/fix_v224_iterator_guest.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v224/' userland/desktop_qt/guest_main.cpp
