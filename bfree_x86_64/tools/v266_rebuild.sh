...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v266*.py tools/v266_rebuild.sh
python3 tools/fix_v266_setcompileunit_guest.py
...
sed -i 's/mmap96-v[0-9a-z]*/mmap96-v266/' userland/desktop_qt/guest_main.cpp
