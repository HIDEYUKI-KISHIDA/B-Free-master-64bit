...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v240_guest_known_imports.py
python3 tools/fix_v240_guest_known_imports.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v240/' userland/desktop_qt/guest_main.cpp
