...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v267*.py tools/v267_rebuild.sh
python3 tools/fix_v267_skip_setcompileunit_guest.py
...
sed -i 's/mmap96-v[0-9a-z]*/mmap96-v267/' userland/desktop_qt/guest_main.cpp
