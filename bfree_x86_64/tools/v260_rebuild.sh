...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v260_*.py tools/v260_rebuild.sh
python3 tools/fix_v260_resolved_types_store_guest.py || true
python3 tools/fix_v260b_resolved_int_slot.py
...
sed -i 's/mmap96-v[0-9a-z]*/mmap96-v260b/' userland/desktop_qt/guest_main.cpp
