...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v248_resolve_typeref_guest.py tools/v248_rebuild.sh
python3 tools/fix_v248_resolve_typeref_guest.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v248/' userland/desktop_qt/guest_main.cpp
