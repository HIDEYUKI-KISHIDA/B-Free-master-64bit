...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v264*.py tools/v264_rebuild.sh
python3 tools/fix_v264_done_skip_guest.py
...
sed -i 's/mmap96-v[0-9a-z]*/mmap96-v264/' userland/desktop_qt/guest_main.cpp
