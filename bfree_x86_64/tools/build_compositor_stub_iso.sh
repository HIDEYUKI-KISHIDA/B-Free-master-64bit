...
# PID1 proof: compositor.elf registered as init.elf on the GUI menuentry.
set -eu
...
grep -q 'module2 /boot/compositor.elf init.elf' "$WORK/grub.new"
...
echo "GRUB_PID1=compositor.elf as init.elf"
