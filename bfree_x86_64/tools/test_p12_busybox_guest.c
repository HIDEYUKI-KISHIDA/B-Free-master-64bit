/*
 * P12_BUSYBOX_GUEST — BusyBox static ELF staged in initramfs for ash guest boot.
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
#ifndef BUSYBOX_ROOTFS_PATH
#define BUSYBOX_ROOTFS_PATH "guest/rootfs/bin/busybox"
#endif

#ifndef BUSYBOX_INITRAMFS_PATH
#define BUSYBOX_INITRAMFS_PATH "guest/initramfs/bin/busybox"
#endif
...
int main(void)
{
	...
	CHECK(read_file(BUSYBOX_ROOTFS_PATH, &built, &built_len) == 0, "built busybox");
	CHECK(read_file(BUSYBOX_INITRAMFS_PATH, &staged, &staged_len) == 0,
	      "initramfs busybox");
