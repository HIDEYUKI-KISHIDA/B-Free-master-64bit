#!/usr/bin/env python3
"""Emit tools/restore_wsl_guest_env.sh with Unix LF."""
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
out = ROOT / "tools/restore_wsl_guest_env.sh"
out.write_bytes(
    r"""#!/usr/bin/env bash
# Restore B-Free guest Qt WSL environment after reinstall / reset.
#
# One command (from repo root, will prompt for sudo password):
#   cd /mnt/c/Users/h_k/Documents/.../bfree_x86_64   # your repo path
...
main "$@"
""".replace("/mnt/c/Users/h_k/Documents/.../bfree_x86_64", "/mnt/c/Users/h_kis/Desktop/B-Free-master/Program/bfree_x86_64").encode("utf-8"),
)
out.chmod(0o755)
print(f"[write] {out}")
