...
cd "$ROOT"
bash tools/patch_qv4mm_allocobject_memberdata_guest.sh
...
BFREE_SMOKE_REBUILD=0 BFREE_FAST_TIMEOUT=300 bash tools/guest_desktop_smoke.sh 2>&1 | tee /tmp/v194-smoke.log | tail -75
