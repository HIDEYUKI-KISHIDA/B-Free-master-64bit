...
cd "$ROOT"
python3 tools/fix_v201_jsstrings_guest.py
rm -f "$BD/src/qml/CMakeFiles/Qml.dir/jsruntime/qv4engine.cpp.o" \
      "$BD/src/qml/CMakeFiles/Qml.dir/jsruntime/qv4identifiertable.cpp.o" \
      "$BD/src/qml/CMakeFiles/Qml.dir/memory/qv4mm.cpp.o"
cmake --build "$BD" --target Qml -j12
cp -a "$BD/lib/libQt6Qml.a" /root/out/bfree-qt6-guest-static/lib/
sed -i 's/mmap96-v[0-9]*/mmap96-v201/' userland/desktop_qt/guest_main.cpp
