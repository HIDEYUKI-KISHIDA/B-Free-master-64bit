...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v243_locate_qmldir_skip_guest.py
python3 tools/fix_v243_locate_qmldir_skip_guest.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v243/' userland/desktop_qt/guest_main.cpp
