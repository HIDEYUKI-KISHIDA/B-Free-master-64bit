...
sed -i 's/\r$//' tools/fix_v241_typedata_embed_source_guest.py
python3 tools/fix_v241_typedata_embed_source_guest.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v241/' userland/desktop_qt/guest_main.cpp
