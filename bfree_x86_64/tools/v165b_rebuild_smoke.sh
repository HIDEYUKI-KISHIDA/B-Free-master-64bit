...
sed -i 's/\r$//' tools/patch_qv4internalclass_guest.sh
...
BFREE_SMOKE_REBUILD=0 BFREE_SMOKE_TIMEOUT=600 bash tools/guest_desktop_smoke.sh 2>&1 | tee /tmp/v165b-smoke.log
