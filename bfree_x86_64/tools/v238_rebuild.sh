...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v238_typedata_contir_guest.py
python3 tools/fix_v238_typedata_contir_guest.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v238/' userland/desktop_qt/guest_main.cpp
