...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v250_resolve_type_guest.py tools/v250_rebuild.sh
python3 tools/fix_v250_resolve_type_guest.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v250/' userland/desktop_qt/guest_main.cpp
