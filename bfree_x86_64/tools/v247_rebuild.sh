...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v247_resolve_types_guest.py tools/v247_rebuild.sh
python3 tools/fix_v247_resolve_types_guest.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v247/' userland/desktop_qt/guest_main.cpp
