...
for s in fix_v211_funcname_guest.py fix_v213_funcproto_guest.py fix_v214_revert_init_guest.py \
  ...
  fix_v227_qqmlengine_guest.py fix_v228_setqmlengine_guest.py fix_v229_typeloader_guest.py; do
  python3 "tools/$s"
done
...
sed -i 's/mmap96-v[0-9]*/mmap96-v229/' userland/desktop_qt/guest_main.cpp
