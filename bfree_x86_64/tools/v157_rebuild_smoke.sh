...
touch /root/src/qt6/qtdeclarative/src/qml/qml/qqmlimport.cpp
...
sleep 1
BFREE_SMOKE_REBUILD=0 BFREE_SMOKE_TIMEOUT=600 bash tools/guest_desktop_smoke.sh 2>&1 | tee /tmp/v157-smoke.log
