...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v244_addlibraryimport_force_guest.py
python3 tools/fix_v244_addlibraryimport_force_guest.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v244/' userland/desktop_qt/guest_main.cpp
