...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v236_typedata_static_url_guest.py
python3 tools/fix_v236_typedata_static_url_guest.py
rm -f "$BD/src/qml/CMakeFiles/Qml.dir/qml/qqmldatablob.cpp.o" \
      "$BD/src/qml/CMakeFiles/Qml.dir/qml/qqml-typedata.cpp.o" 2>/dev/null || true
...
sed -i 's/mmap96-v[0-9]*/mmap96-v236/' userland/desktop_qt/guest_main.cpp
