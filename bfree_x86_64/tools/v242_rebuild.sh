...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v242_setbaseurl_guest.py
python3 tools/fix_v242_setbaseurl_guest.py
rm -f "$BD/src/qml/CMakeFiles/Qml.dir/qml/qqmlimport.cpp.o" \
      "$BD/src/qml/CMakeFiles/Qml.dir/qml/qqmltypedata.cpp.o"
cmake --build "$BD" --target Qml -j12
cp -a "$BD/lib/libQt6Qml.a" /root/out/bfree-qt6-guest-static/lib/
sed -i 's/mmap96-v[0-9]*/mmap96-v242/' userland/desktop_qt/guest_main.cpp
