...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v233_typeloader_qrc_guest.py
python3 tools/fix_v233_typeloader_qrc_guest.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v233/' userland/desktop_qt/guest_main.cpp
