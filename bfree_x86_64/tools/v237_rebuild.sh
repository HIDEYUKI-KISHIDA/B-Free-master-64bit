...
sed -i 's/\r$//' tools/fix_v237_irbuilder_guest.py
python3 tools/fix_v237_irbuilder_guest.py
rm -f "$BD/src/qml/CMakeFiles/Qml.dir/compiler/qqmlirbuilder.cpp.o"
cmake --build "$BD" --target Qml -j12
cp -a "$BD/lib/libQt6Qml.a" /root/out/bfree-qt6-guest-static/lib/
sed -i 's/mmap96-v[0-9]*/mmap96-v237/' userland/desktop_qt/guest_main.cpp
