...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v257_addlibraryimport_qtqml_guest.py tools/v257_rebuild.sh
python3 tools/fix_v257_addlibraryimport_qtqml_guest.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v257/' userland/desktop_qt/guest_main.cpp
