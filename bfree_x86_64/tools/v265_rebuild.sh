...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v265*.py tools/v265_rebuild.sh
python3 tools/fix_v265_done_post_compile_guest.py
...
sed -i 's/mmap96-v[0-9a-z]*/mmap96-v265/' userland/desktop_qt/guest_main.cpp
