...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v260*.py tools/fix_v261*.py tools/v261_rebuild.sh
python3 tools/fix_v260_resolved_types_store_guest.py || true
python3 tools/fix_v260b_resolved_int_slot.py || true
python3 tools/fix_v261_inline_resolve_guest.py
...
sed -i 's/mmap96-v[0-9a-z]*/mmap96-v261/' userland/desktop_qt/guest_main.cpp
