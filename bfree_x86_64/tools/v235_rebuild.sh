...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v235_datablob_urlstring_guest.py
python3 tools/fix_v235_datablob_urlstring_guest.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v235/' userland/desktop_qt/guest_main.cpp
