...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v263*.py tools/v263_rebuild.sh
python3 tools/fix_v263_build_cache_early_guest.py
...
sed -i 's/mmap96-v[0-9a-z]*/mmap96-v263/' userland/desktop_qt/guest_main.cpp
