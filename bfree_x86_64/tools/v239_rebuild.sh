...
cd "$ROOT"
sed -i 's/\r$//' tools/fix_v239_typedata_skip_qmldir_guest.py
python3 tools/fix_v239_typedata_skip_qmldir_guest.py
...
sed -i 's/mmap96-v[0-9]*/mmap96-v239/' userland/desktop_qt/guest_main.cpp
