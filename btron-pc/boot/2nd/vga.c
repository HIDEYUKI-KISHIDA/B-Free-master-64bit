 ...
 * �����ץ˥󥰲��̤Υ��᡼���ե������ hanko.xbm ���� opening.xbm ���ѹ���
 *
...
clear_vga(int color)
{
  ...
  for (i = 0; i < 80 * 480; i++)
    {
      *gvram++ = 0;		/* �����ǽ񤭹���Ǥ����� 0 �ϡ�VGA ����ȥ�����ϻ��Ȥ��ʤ���
				 * Enable Set/Reset register �ˤ�äơ������ͤ�̵�뤹��褦��
				 * �ʤäƤ��롣
				 */
    }
...
vga_graph ()
{
  ...
  change_mode (&mode12);		/* VGA mode 12 ���ѹ� */
