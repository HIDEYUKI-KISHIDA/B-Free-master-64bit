...
#define HD_LENCODE	2
#ifdef notdef
#define HD_GAP		0x2A		/* HD �ξ��� GAP3 ���� */
#else
#define HD_GAP		0x1B		/* HD �ξ��� GAP3 ���� */
#endif
#define HD_DTL		0xff
...
extern int	stop_motor (int drive);
