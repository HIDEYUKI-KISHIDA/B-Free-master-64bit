...
struct sfs_superblock
{
  ...
  unsigned long	sfs_isearch;		/* �����ֹ�ʲ��� inode �ϻ����� */
  unsigned long	sfs_bsearch;		/* �����ֹ�ʲ��� block �ϻ����� */

  unsigned long	sfs_datablock;		/* �ǡ����ΰ�γ��ϰ��֡�
				 * inode �ϡ������ѡ���
				 * ���å���ľ��ˤʤ�Τǡ�
				 * �ä˵�Ͽ���ʤ���*/
};
...
struct sfs_inode
{
  unsigned long	sfs_i_index;	/* SFS �ξ�硢inode �� 1 ����Ϥ��ޤ� */
...
struct sfs_dir
{
  unsigned long	sfs_d_index;		/* inode �ֹ� */
