...
#ifndef IDEC_DUMMY_DECLS
#define IDEC_DUMMY_DECLS
int putchar(int c);
...
int ide_read_low (int drive, int cyl_b, int head_b, int sec_b, void *buf, int length);
...
int
ide_read_low (int drive, int cyl_b, int head_b, int sec_b, void *buf, int length)
{
  int	stat;
  int	i;
  UWORD16 *tmpbuf;
