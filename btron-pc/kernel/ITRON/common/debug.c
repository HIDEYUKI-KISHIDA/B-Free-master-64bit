...
*/
/* debug.c --- �ǥХå��ѥ��ޥ�ɥ饤�󥤥󥿥ץ��
 *
 * $Revision: 1.1 $
 *
 *	���Υե�����ˤϡ��ǥХå��ѤΥ��ޥ�ɥ饤�󥤥󥿥ץ꥿�⥸�塼�뤬���롣
 *
 * 	���ޥ�ɥ饤�󥤥󥿥ץ�󥿤ϡ������� shell �ȸƤФ�� UNIX ��Υ桼��
 *	����ƥ���Ʊ���褦��ư��򤹤롣
 *	���������������Ǥϡ��������ޥ�ɤϻ��ѤǤ��ʤ�(���ѤǤ��륳�ޥ�ɤϡ�����
 *	�Ƥ��Υ⥸�塼�������������)��
 *
 */
...
static ER	eval (B *linebuf);
static ER	readc (ID port, ID resport);
static void	wakeup_func (VP arg);

extern W	getchar (void);
extern void	delete_key (void);
extern W	move_cursol (int x, int y);
extern void	run (W entry);
...
{
  {"version",	f_version,	1,	1},	/* �С�������ֹ��ɽ��		*/
  {"help",	f_help,		1,	1},	/* �إ�ץ�å�������ɽ��	*/
  {"dump",	f_dump,		2,	3},	/* ��������			*/
  {"ps",	f_ps,		1,	1},	/* �ץ������ꥹ��		*/
  {"status",	f_status,	-1,	-1},	/* ���ơ�����                   */
  {"free",	f_free,		1,      2},      /* �����񸻤ξ��֤�ɽ��         */
  {"suspend",	f_suspend,	2,	2},	/* ���ꤷ���������Υ����ڥ��   */
  {"wakeup",	f_wakeup,	2,	2},	/* �����ڥ�ɤ����������� wakeup*/
  {"reset",	f_cpureset,	1,	1},	/* �ãУդΥꥻ�å�		*/
  {"ioecho",	f_ioecho,	2, 	2},	/* echo �ǥХ����ɥ饤�Ф�write��å����������� */
  {"gdc",	f_gdc_test,	1,	1},	/* GDC�Υƥ�����		*/
  {"demo",	f_demo,		1,	1},	/* �ǥ��Ѵؿ�			*/
  {"syscall",	f_syscall,	1,	1},	/* �����ƥॳ����Υƥ����� 	*/
  {"bootinfo",	f_bootinfo,	1,	1},	/* �֡��Ⱦ����ɽ��             */
  {"run-module",f_run_module,	2,	2},	/* �֡��Ȼ��˥����ɤ� */
						/* ���⥸�塼��μ¹� */
  {"timer",	f_timer,	1,	1},
  {"console", 	f_console_test,	1,	1},	/* */
  {"keyboard", 	f_keyboard_test,1,	1},	/* */
  {"fd",	f_fd_test,	1,	2},	/* FD �Υƥ��� */
  {"fdwrite",	f_fd_write,	1,	2},	/* FD �� write */
  {"fdmod",	f_fd_chmod,	1,	2},	/* FD �Υ⡼���ڴ��� */
  {"scsi",	f_scsi,		1,	2},	/* SCSI �Υƥ��� */
...
f_ioecho (W ac, B **av)
{
  ...
  err = ref_dev (DEVNAME_ECHO, CHAR, &id);
  if (err != E_OK)
    {
...
f_gdc_test (W ac, B **av)
{
  ...
  err = ref_dev (DEVNAME_PD7220, CHAR, &id);
  if (err != E_OK)
    {
      printk ("debug: cannot get io device (ECHO)\n");
      return;
